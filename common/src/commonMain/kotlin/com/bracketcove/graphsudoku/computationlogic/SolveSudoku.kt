...
internal fun SudokuPuzzle.solve()
    ...
    val assignments = mutableListOf<SudokuNode>()
    ...
    //work with a copy
    var newGraph = HashMap(this.graph)
    //all nodes which are of 0 value (uncolored)
    val uncoloredNodes = mutableListOf<SudokuNode>()
...
fun getPossibleValues(adjList: List<SudokuNode>, boundary: Int): List<Int> {
