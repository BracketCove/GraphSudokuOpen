...
internal fun buildNodes(n: Int, difficulty: DIFFICULTY): SudokuPuzzle {
    val newMap = HashMap<Int, List<SudokuNode>>()
    ...
    (1..n).forEach { xIndex ->
        (1..n).forEach { yIndex ->
            ...
            val newList = mutableListOf<SudokuNode>()
            newList.add(newNode)
            newMap.put(
                    newNode.hashCode(),
                    newList
...
internal fun SudokuPuzzle.buildEdges(): SudokuPuzzle {
    this.graph.forEach {
        ...
        this.graph[getHash(x, y)] = newList
    }
    return this
}
 ...
 */
internal fun MutableList<SudokuNode>.mergeWithoutRepeats(new: List<SudokuNode>) {
